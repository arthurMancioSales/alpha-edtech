...
ws.addEventListener("message", (event) => {
    ...
    switch (message.type) {
        case "enterError":
            handleEnterError(message)
            break;
        case "enterSuccess":
            handleEnterSucess()
            break;
        case "allQuestions":
            handleAllQuestions(message.questions)
            break;
        case "newQuestionError":
            handleNewQuestionError(message)
            break;
        case "newQuestion":
...
function handleEnterError(message) {
    alert(message.message)
}

function handleEnterSucess() {
    gameContainer.style.display = "block"
}

function handleAllQuestions(questions) {
...
function handleNewQuestionError(message) {
    alert(message.message)
}
...
function handleVoteUpdate(message) {
    updateVoteCountUI(message.update)
}